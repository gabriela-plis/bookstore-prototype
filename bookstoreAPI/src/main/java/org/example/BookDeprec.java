...
public class BookDeprec implements DBObject, Readable {
    ...
    public BookDeprec(String title, String author, String series, String publishYear, int availableAmount, boolean canBeBorrow, int ID) {
        this.title = title;
        this.author = author;
        this.series = series;
    ...
    public BookDeprec(String title, String author, String series, String publishYear, int availableAmount, int borrowedAmount, int ID, boolean canBeBorrow) {
        this.title = title;
        this.author = author;
        this.series = series;
        this.publishYear = publishYear;
